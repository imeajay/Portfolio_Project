...
class Projects extends Component {
  ...
  toggleCategories() {
    ...
    if(this.state.activeTab === 0){
      ...
      const url_link1='url(https://reactapp.ir/wp-content/uploads/reactjs.jpg)center/cover'
      return (
        <div>
          {/* Project 1 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '176px',textAlign:"center", background:url_link1}} >React Project #1</CardTitle>
            <CardText>
